...
public class RegionFileCache {
    ...
    public static CompletableFuture<byte[]> getChunkDeflatedDataAsync(String path, int chunkX, int chunkZ) {
    ...
    public static CompletableFuture<Void> putChunkDeflatedDataAsync(String path, int chunkX, int chunkZ, byte[] data) {
        File basePath = new File(path);
        RegionFile r = getRegionFile(basePath, chunkX, chunkZ);

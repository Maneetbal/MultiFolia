...
public class ServerConnection extends MasterBoundMessageHandler {
    ...
    @Override
    public void handle(ReadFileMessage message) {
        ReadFileHandler.handle(this, message);
    }
    ...
    @Override
    public void handle(WriteFileMessage message) {
        WriteFileHandler.handle(this, message);
    }

...
jobs:
  build:
    ...
    steps:
      ...
      - run: git config --global user.name 'MultiFolia Automation'
...
git add -A
git commit -m 'Materialize official Folia 26.2 tree'
